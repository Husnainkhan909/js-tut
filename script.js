...
//        userNum = prompt("This num is wrong: guess again ");
//    }

//    console.log("congratulation u enter right number ");
// }*/
// {
//     let i = 10;
...
//         sum += i; 
//     }
//     console.log( " sum of this value is " + sum);
// } 
// {
//     for( let i = 0; i <= 20; i++){
//         if (i % 2 !== 0){
...
let marks = [95, 45, 32, 78, 60, 88,53,93,79,40,9]; 
...
for (let i = 0; i < marks.length; i++) {
    ...
    if (marks[i] >= 90) {
        result = "Excellent";
        console.log(`student is ${i} = ${result}`);
    } else if (marks[i] >= 75) {
        result = "Very Good";
          console.log(`student is ${i} = ${result}`);
    } else if (marks[i] >= 60) {
...
let salary = [100000, 75000, 32000, 78000, 60000, 8000,53000,93000]; 
...
for (let i = 0; i < salary.length; i++) {
    ...
    if (salary[i] >= 100000) {
        tax = "20%";
        console.log(`Employ has ${i} = ${tax}`);
    } else if (salary[i] >= 60000) {
        tax = "10%";
          console.log(`Employ has ${i} = ${tax}`);
    } else if (salary[i] >= 30000) {
        tax = "5%";
          console.log(`Employ has ${i} = ${tax}`);
    } 
     else {
...
{
    let num = [22,12,24,56,87,98,78,67];
